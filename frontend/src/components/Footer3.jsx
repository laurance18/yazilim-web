            ...
            <div className='text-white grid grid-cols-4'>
                ...
                <div className='border-r-2 border-white/20 px-2'>
                    ...
                    <ul>
                        ...
                        <li className='my-5 ml-3'><a href="">Biz Kimiz?</a></li>
                        <li className='my-5 ml-3'><a href="">Etkinlikler</a></li>
                        <li className='my-5 ml-3'><a href="">Sıkça Sorulan Sorular</a></li>
                        <li className='my-5 ml-3'><a href="">İletişim</a></li>
                ...
                <div className='border-r-2 border-white/20 px-2'>
                    ...
                    <div>
                        <div className='my-5 ml-3'><a href="https://www.instagram.com/iyte_yazilim/" target="_blank" className='text-gray-400 hover:text-gray-500 flex items-center'>
                        ...
                        <div className='my-5 ml-3'><a href="https://www.linkedin.com/company/iyteyazilim/" target="_blank" className='text-gray-400 hover:text-gray-500 flex'>
                        ...
                        <div className='my-5 ml-3'><a href="https://www.facebook.com/IYTESS" target="_blank" className='text-gray-400 hover:text-gray-500 flex'>
                            <svg className="w-6 h-6" aria-hidden="true" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <div className='my-5 ml-3'><a href="https://github.com/IYTE-Yazilim-Toplulugu" target="_blank" className='text-gray-400 hover:text-gray-500 flex'>
                            <svg className="w-6 h-6" aria-hidden="true" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <div className='my-5 ml-3'><a href="https://www.youtube.com/@iyteyazilimtoplulugu" target="_blank" className='text-gray-400 hover:text-gray-500 flex'>
